#####################################################################
#                                                                   #
# /labscript_devices/ThorlabsWaveFrontSensor/register_classes.py    #
#                                                                   #
...
blacs_tab = 'labscript_devices.ThorlabsWaveFrontSensor.blacs_tabs.ThorlabsWaveFrontSensorTab'
# parser = 'labscript_devices.TCPDH_Synth.runviewer_parsers.TCPDH_SynthTab'

labscript_devices.register_classes(
#    labscript_device_name=labscript_device_name,
    labscript_device_name='ThorlabsWaveFrontSensor',
    BLACS_tab=blacs_tab,
